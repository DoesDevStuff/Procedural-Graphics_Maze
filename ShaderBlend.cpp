...
bool Shader2::InitStandard(ID3D11Device* device, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	samplerDesc.AddressU = D3D11_TEXTURE_ADDRESS_WRAP;// used to be D3D11_TEXTURE_ADDRESS_MIRROR   OR  D3D11_TEXTURE_ADDRESS_WRAP
...
bool Shader2::SetShaderParameters(ID3D11DeviceContext* context, DirectX::SimpleMath::Matrix* world, DirectX::SimpleMath::Matrix* view, DirectX::SimpleMath::Matrix* projection, Light* sceneLight1, ID3D11ShaderResourceView* texture1, ID3D11ShaderResourceView* texture2)
{
...
void Shader2::EnableShader(ID3D11DeviceContext* context)
{
