...
{
	m_ObjDimensions.x = xwidth;
	m_ObjDimensions.y = yheight;
	m_ObjDimensions.z = zdepth;
...
DirectX::SimpleMath::Vector3 ModelClass::GetDimensions()
{
	return m_ObjDimensions;
}

void ModelClass::SetCentre(DirectX::SimpleMath::Vector3 centre)
{
	m_ObjCentre = centre;
}

DirectX::SimpleMath::Vector3 ModelClass::GetCentre()
{
	return m_ObjCentre;
}
